...
export class usariosSedes1614311002887 implements MigrationInterface {
    name = 'usariosSedes1614311002887'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `Sede` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(240) NOT NULL, `id_city` int NULL, UNIQUE INDEX `IDX_25cc2e7c6d2a4f9c2f0ace0d02` (`name`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
